...
// Face detection/recognition off: Arduino CLI build does not supply ESP-WHO human_face_detect_* headers.
// Camera streaming and controls are unchanged.
...
// Enable LED FLASH setting (PlatformIO may set -DCONFIG_LED_ILLUMINATOR_ENABLED=0 for older LEDC API)
...
void enable_led(bool en) {  // Turn LED On or Off
  ...
  ledcWriteChannel(LED_LEDC_CHANNEL, duty);
...
#if CONFIG_LED_ILLUMINATOR_ENABLED
  // Arduino-ESP32 3.x LEDC API (replaces ledcSetup + ledcAttachPin)
