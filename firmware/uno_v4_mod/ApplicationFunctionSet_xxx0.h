...
public:
  ...
  // mod: continuous heading and telemetry stream
  float Yaw_deg = 0;                 // integrated gyro heading, degrees, updated every loop
  unsigned int StreamPeriod_ms = 0;  // N=25 D1: telemetry period, 0 = off
  unsigned long Stream_time = 0;
  unsigned long MotorSpeed_time = 0; // last N=4 command, for the deadman
